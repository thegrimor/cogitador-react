                  ...
                  >
                    <div className="flex flex-col gap-0.5">
                      <p className={[
                        ...
                        {char.info.name || (char.id === 'inquisidor' ? 'Inquisidor' : 'Séquito')}
                      </p>
