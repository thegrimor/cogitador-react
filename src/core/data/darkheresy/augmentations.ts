...
export const AUGMENTATIONS: AugmentationDefinition[] = [
  ...
  { name: 'Limitador nulo', loc: 'Cuello / Neural', desc: 'Implante (ver Acoplamiento de Biónica e Implantes) que proyecta estática psíquica y suprime el área de quietud psíquica de un Nulo/Paria mientras está activo, permitiendo usar poderes psíquicos con normalidad cerca de él; el resto de efectos del rasgo Nulo se mantienen. Activar/desactivar es acción libre. No puede usarse contra el rasgo Paria (no lo suprime). Coste 5000, Muy raro.', bonus: 'Neutraliza el área de quietud psíquica del portador mientras está activo (acción libre on/off)' },
]
